    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">LoyaltyBoost</div>
            </a>
            ...
            <!-- Nav Item - Clients -->
            <li class="nav-item">
                <a class="nav-link" href="gestion_client.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Clients</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="catalogueDePrestation.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Catalogue de prestation</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Entreprises partenaires Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
